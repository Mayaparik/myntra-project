...
const { mobileContext, setMobileContext } = useContext(MobileViewContext)
  ...
  return (
    <div className='relative group lg:py-7 py-3 px-4'>
      <button onClick={() => testing("gens")}>GENS</button>
...
{/* Mobile-dropdown */}
      {
        mobileContext.gens == true && (
          <div className='w-70 fixed lg:opacity-0 transition-opacity duration-300  overflow-scroll right-13 top-16 mx-16 h-full ' style={{ scrollbarWidth: "none" }}>
