  ...
  function testing(title) {
    ...
    return (
        <div className='relative group flex flex-col items-center text-black cursor-pointer px-3 py-4'>
            ...
            <button onClick={() => testing("profile")} className="text-sm font-semibold">Profile</button>
            ...
            {
                mobileContext.profile == true && (
                    <div className=' fixed lg:opacity-0 transition-opacity duration-300 mx-10 overflow-scroll right-17  top-16  h-full ' style={{ scrollbarWidth: "none" }}>
                        <div className='bg-white py-7 px-5 text-left text-sm space-y-3'>
                            <div className=''>
                                <p className='font-bold'>Welcome</p>
                                <p className='text-gray-600'>To access account and manage orders</p>
                                <button className='px-3 py-2 border border-gray-300 my-2 font-bold rounded-xs hover:border-pink-500 text-pink-500'><Link to='/signup'>LOGIN/SIGNUP</Link></button>
